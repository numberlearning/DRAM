...
def read(x, h_point_prev, glimpse, testing=None):
    Fx_1, Fy_1, Fx_2, Fy_2, gamma, gx, gy, gx_real, gy_real = attn_window("read", blob_list, h_point_prev, read_n, glimpse, gx_prev, gy_prev, testing=None)
...
for glimpse in range(glimpses):
    r, stats = read(x, h_point_prev, glimpse, None)
