...
class InputData(object):
    ...
    def get_train(self, even, testing, min_blobs, max_blobs): # MT
        """Generate and get train images and labels."""
        self.images, self.labels = create_data2.generate_data(even, testing, min_blobs, max_blobs) # MT
        self.length = len(self.images)


    def get_test(self, even, testing, min_blobs, max_blobs): # MT
