...
train_iters = 100000#20000000000
...
if __name__ == '__main__':
    ...
    for i in range(start_restore_index, train_iters+1):
        ...
        blbs, potxs_fetched, potys_fetched, prdxs_fetched, prdys_fetched, counts_fetched, corrects_fetched, count_accuracy_fetched, point_accuracy_fetched, predcost_fetched, _ = results
