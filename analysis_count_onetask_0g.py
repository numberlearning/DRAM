...
from Ct_2l_1t_0g_viz import points, corrects, points, classification, classifications, x, count_word, blob_list, size_list, batch_size, output_size, dims, read_n, delta_1, delta_2 
import load_count
