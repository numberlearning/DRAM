...
from COUNT_viz_onetask_nogamma import points, corrects, points, classification, classifications, x, count_word, blob_list, size_list, batch_size, output_size, dims, read_n, delta_1, delta_2 
import load_count
...
def classify_imgs2(it, new_imgs, num_imgs, path=None): 
    ...
    for idx in range(num_imgs):
        ...
        for glimpse in range(glimpses):
            cs.append(human_cs[0][glimpse]["classification"])
...
print("analysis_count_onetask.py")
