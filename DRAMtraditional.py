...
restore = True #str2bool(sys.argv[14]) #True
rigid_pretrain = False
log_filename = "second-run/log.csv" #sys.argv[7] #"translatedplain/classify_weird_from_20000_log.csv"
load_file = "first-run/save_322000.ckpt" #sys.argv[8] #"translatedplain/drawmodel20000.ckpt"
save_file = "second-run/save_" #sys.argv[9] #"translatedplain/classifymodel_weird_from_20000_"
draw_file = "second-run/draw_" #sys.argv[10] #"translatedplain/zzzdraw_data_5000.npy"
start_non_restored_from_random = False #str2bool(sys.argv[15])
dist_size = (9, 9)
ORG_SHP = [28, 28]
OUT_SHP = [100, 100]
