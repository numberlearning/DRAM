...
folder_name + "/precount_"] #sys.argv[10]~[14]
print(sys.argv)

train_iters = 1500000#20000000000
...
if __name__ == '__main__':
    ...
    for i in range(start_restore_index*3, train_iters+3):
        ...
        if i<100 or cot_quality<1:
            ...
            cot_quality -= count_accuracy_fetched 
            ...
            if i%100==0:
                ...
                pot_count=0
                print("iter=%d" % (i))
                print("PreCount: cot_accuracy: %f, Pc: %f" % (cot_quality, pot_Pc))
            if i%1000==0:
                train_data = load_count.InputData()
                train_data.get_train(None, min_blobs_train, max_blobs_train) # MT
