...
from analysis import classify_image_twolayer, glimpses, read_n, delta_1, classify_imgs2

clear_output()
b = Button(description="Loading...", icon="arrow", width=400)
dropdown = Dropdown(
    options=['0', '10000', '20000', '30000', '40000', '50000', '60000', '70000', '80000', '90000', '100000', '110000', '120000', '130000', '140000', '150000', '160000', '170000', '180000', '190000', '200000', '250000', '300000', '400000', '500000', '600000', '700000', '800000', '900000', '1000000', '1100000', '1200000', '1300000', '1400000', '1500000'],
    value='10000',
...
def make_figure(color, i, smol=False):
    """
...
def update_figures(handle, new_image=True):
    global data
    data = classify_image_twolayer(int(dropdown.value), new_image)
