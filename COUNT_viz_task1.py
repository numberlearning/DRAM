...
if __name__ == '__main__':
    ...
    for i in range(start_restore_index, train_iters):
        ...
        results = sess.run(fetches2, feed_dict = {x: bxtrain, onehot_labels: bytrain, blob_list: bztrain, size_list: bstrain, mask_list: bmtrain, num_list: bntrain, count_word: bctrain})
