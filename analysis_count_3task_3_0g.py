...
from Ct_2l_3t_0g_3_viz import corrects, classification, classifications, points, x, count_word, blob_list, size_list, batch_size, output_size, dims, read_n, delta_1, delta_2 
...
def load_checkpoint(it, human=False, path=None):
    saver.restore(sess, "%s/prepoint_%d.ckpt" % (path, it))
