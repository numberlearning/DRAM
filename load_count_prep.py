...
class InputData(object):
    ...
    def get_train(self, even, min_blobs, max_blobs): # MT
        ...
        self.images, self.labels, self.blob_list, self.size_list, self.mask_list, self.num_list, self.count_word = create_data_count_prep.generate_data(even, min_blobs, max_blobs) # MT
