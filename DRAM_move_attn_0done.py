...
import sys
import load_teacher
from model_settings import learning_rate, glimpses, batch_size, min_edge, max_edge, min_blobs_train, max_blobs_train, min_blobs_test, max_blobs_test, model_name
...
z_size = max_blobs_train - min_blobs_train + 1 # QSampler output size
