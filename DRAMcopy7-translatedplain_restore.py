...
"translatedplain_restore/classify_weird_from20000_log.csv",
"translatedplain_restore/classifymodel_weird_from_20000_90000.ckpt",
"translatedplain_restore/classifymodel_weird_from_20000_",
"translatedplain_restore/zzzdraw_data_5000.npy",
...
if classify:
    ...
    for i in range(start_restore_idx, train_iters):
        xtrain, ytrain =train_data.next_batch(batch_size)
        if translated:
            xtrain = convertTranslated(xtrain)
        feed_dict={x:xtrain, onehot_labels:ytrain}
