...
if __name__ == '__main__':
    ...
    for i in range(start_restore_index, train_iters):
        ...
        if i%2==0 and i<50000:#point_accuracy_prev < threshold:
            results = sess.run(fetches2, feed_dict = {task1: True,testing: False, x: xtrain, onehot_labels: ytrain, blob_list: ztrain, size_list: strain, mask_list: mtrain, num_list: ntrain, count_word: ctrain})
        elif i%2!=0 and i<50000:
            results = sess.run(fetches2, feed_dict = {task1: True,testing: True, x: xtrain, onehot_labels: ytrain, blob_list: ztrain, size_list: strain, mask_list: mtrain, num_list: ntrain, count_word: ctrain})
        elif i%2==0 and i>=50000:
